...
if ( CLIENT ) then
	...
	language.Add( "Tool_turret_name", "Turret" )
	language.Add( "Tool_turret_desc", "Throws bullets at things" )
	language.Add( "Tool_turret_0", "Click somewhere to spawn an turret. Click on an existing turret to change it." )
	
	language.Add( "Tool_turret_spread", "Bullet Spread" )
	language.Add( "Tool_turret_numbullets", "Bullets per Shot" )
	language.Add( "Tool_turret_force", "Bullet Force" )
	language.Add( "Tool_turret_sound", "Shoot Sound" )
...
function TOOL.BuildCPanel( CPanel )
	...
	// HEADER
	CPanel:AddControl( "Header", { Text = "#Tool_turret_name", Description	= "#Tool_turret_desc" }  )
	...
	// Shot sounds
	local weaponSounds = {Label = "#Tool_turret_sound", MenuButton = 0, Options={}, CVars = {}}
	...
	if ( SinglePlayer() ) then
		...
		CPanel:AddControl( "Slider",  { Label	= "#Tool_turret_numbullets",
									Type	= "Integer",
									Min		= 1,
									Max		= 10,
	...
	CPanel:AddControl( "Slider",  { Label	= "#Tool_turret_spread",
									Type	= "Float",
									Min		= 0,
									Max		= 1.0,
									Command = "turret_spread" }	 )

	CPanel:AddControl( "Slider",  { Label	= "#Tool_turret_force",
									Type	= "Float",
									Min		= 0,
									Max		= 500,
