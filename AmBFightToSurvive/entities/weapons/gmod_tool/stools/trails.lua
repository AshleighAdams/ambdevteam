...
function TOOL.BuildCPanel( CPanel )
	...
	// HEADER
	CPanel:AddControl( "Header", { Text = "#Tool_trails_name", Description	= "#Tool_trails_desc" }  )
	
	// Presets
	local params = { Label = "#Presets", MenuButton = 1, Folder = "trails", Options = {}, CVars = {} }
	...
	CPanel:NumSlider( "#Length", "trails_length", 0, 10, 2 )
	CPanel:NumSlider( "#Start Size", "trails_startsize", 0, 128, 2 )
	CPanel:NumSlider( "#End Size", "trails_endsize", 0, 128, 2 )
